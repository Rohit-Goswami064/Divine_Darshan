export const translations = {
  en: {
    ...
    loginModal: {
      ...
      signupSubtitle: 'Join Divine Darshan to start your spiritual journey.',
      nameLabel: 'Full Name',
    ...
    bookingModal: {
        ...
        buttons: {
            ...
            confirm: 'Confirm & Proceed to Pay',
